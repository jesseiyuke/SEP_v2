...
import { generateInputs, generateLinks } from "../GenerateHTML.js";
...
export default class extends AbstractView {
    ...
    async getHtml() {
        ...
        const profileNavigtaion = document.createElement('nav');
        profileNavigtaion.classList.add('navbar');

        const personalDetailsLink = generateLinks("Personal Details", "/PersonalDetails", true);
        const educationLink = generateLinks("Education", "/PersonalDetails", false);
        const workExperienceLink = generateLinks("Work Experience", "/PersonalDetails", false);
        const refereesLink = generateLinks("Referees", "/PersonalDetails", false);

        profileNavigtaion.appendChild(personalDetailsLink);
        profileNavigtaion.appendChild(educationLink);
        profileNavigtaion.appendChild(workExperienceLink);
        profileNavigtaion.appendChild(refereesLink);
